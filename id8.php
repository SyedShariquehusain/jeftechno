			...
			<div class="container">
				<div class="row">
						...
						<div class="single-sidebar-widget">
							<div class="special-links">
								...
								<li>
                                    ...
                                    <li>
										<a class="active" href="id8.php">Power Plants</a>
									</li>
                                    <li>
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						<div class="full-pic">
							<figure>
								<img src="assets/images/Power Plants.png" alt="">
							</figure>
						</div>
							...
							<div class="row mt-45 mt-xs-15 clearfix">
								...
								<div class="col-md-7 text-box">
									<div class="box-title mb-20 mt-sm-30 mt-xs-30">
										<h3>We offer comprehensive solutions for Power Plants;</h3>
									</div>
									<div class="text-content">
										<p>
										•	Risk Assessment & Root Cause Analysis<br>
										
										•	Grounding System Health Assessment<br>
										•	Lightning Protection System Adequacy Studies<br>
