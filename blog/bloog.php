							...
							<div class="col-md-9 nav-bg">
								<nav class="navigation">
									<ul>
										...
										<li>
											<a href="#!">About us</a><i class="ion-ios-plus-empty hidden-md-up"></i>
											<ul class="sub-nav">
												<li>
										...
										<li>
											<a href="#!">Shop</a><i class="ion-ios-plus-empty hidden-md-up"></i>
											<!-- Nav Dropdown -->
											<ul class="sub-nav">
												<li>
										...
										<li>
											<a href="#!">Contact us</a><i class="ion-ios-plus-empty hidden-md-up"></i>
											<ul class="sub-nav">
												<li>
            ...
            <div class="col-md-12 blog-post-hr">
              <div class="blog-post mb-30">
                ...
                <div class="post-header">
                  <h2><a href="blog-detail.html">AUTOMATED LIGHTNING RISK ASSESMENT AND TOOL</a></h2>
                </div>
                <div class="post-entry">
                  <h3>Automated lightning risk assesment and tool</h3>
                </div>
              ...
              <div class="blog-post mb-30">
                ...
                <div class="post-header">
                  <h2><a href="blog/automated-lightning-risk.php">ELECTRICAL FIRE IN COVID-19 HOSPITALS A PREVENTABLE EMERGENCY</a></h2>
                </div>
                <div class="post-entry">
                  <h4>Electrical Fire in Covid-19 Hospitals A Preventable Emergency</h4>
                </div>
                <div class="post-more-link pull-left"> <a href="blog-detail.html" class="btn-text">Read More</a> </div>
              </div>
              ...
              <div class="blog-post mb-30">
                ...
                <div class="post-meta"> <span>by <a href="javascript:avoid(0);">Admin</a>,</span><span> <a href="javascript:avoid(0);"><i class="fa fa-comment-o"></i> 25</a>,</span><span> <a href="javascript:avoid(0);"><i class="fa fa-heart-o"></i> 57</a>,</span>
                  <div class="post-more-link pull-right">
                    ...
                    <a class="btn-text xs-hidden"> <i class="ion-android-share-alt"></i></a> </div>
                <div class="post-header">
                  <h2><a href="blog-detail.html">How to assess lightning risk quickly? - GET THE REPORT WITHIN 5 MINUTES!!!</a></h2>
                </div>
                <div class="post-entry">
                 <h4>How to assess lightning risk quickly? - GET THE REPORT WITHIN 5 MINUTES!!!</h4>
                </div>
                <div class="post-more-link pull-left"> <a href="blog-detail.html" class="btn-text">Read More</a> </div>
              </div>
              <hr />
