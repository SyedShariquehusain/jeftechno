			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						<div class="full-pic">
							<figure>
								<img src="assets/images/Renewable Energy.png" alt="">
							</figure>
						</div>
						<div class="text-box mt-40">
							<div class="box-title mb-20">
								<h2> Renewable Energy Segment (Solar Power and Wind Power):</h2>
							...
							<div class="row mt-45 mt-xs-15 clearfix">
								...
								<div class="col-md-7 text-box">
									<div class="box-title mb-20 mt-sm-30 mt-xs-30">
										<h3>We offer comprehensive solutions for the solar & wind power segment;</h3>
									</div>
									<div class="text-content">
										<p>
