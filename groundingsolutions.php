			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-sx-12">
						<div class="single-sidebar-widget">
							<div class="special-links">
								<ul>
									<li>
										<a class="active" href="#">Grounding Solutions</a>
									</li>
									<li>
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						<div class="full-pic">
							<figure>
								<img src="assets/images/Grounding Solutions Main Banner.png" alt="">
							</figure>
						</div>
						<div class="text-box mt-40">
							<div class="box-title mb-20">
								<h2>GROUNDING/EARTHING SOLUTIONS</h2>
							...
							An effective grounding system is a fundamental requirement of any electrical system for operational and safety aspects/reasons. Without a good grounding system safety of equipment and human life are in danger. Essentially, every electrical installation needs a reliable grounding system. 
								...
								<p>
								    •	Human/Life Safety<br>
									•	Limiting damage to electrical equipment in case of fault/lightning<br>
							...
							<div class="row mt-45 mt-xs-15 clearfix">
								...
								<div class="col-md-7 text-box">
									...
									<div class="text-content">
										<p>
										•	Cost-effective solution forreliable and robust grounding system.<br>
										•	Ensures Human and Equipment Safety.<br>
										•	Indigenized Earthing Compound offeringMaintenance-free Grounding solution.<br>
										•	Electrode (UL-listed) and compound type tested as per IEC-62561-7, IS3043-2018 & IEEE 80.  <br>
