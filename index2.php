...
<html lang="en">
	<head>
				...
				<div class="banner_slide">
					<div class="slide_box">
						<div class="pull-left">
							...
							<a href="#!" class="btn btn-text dark_btn mt-15">Purchase Garmentt</a>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-4 mb-xs-30">
						<div class="about_comp">
							...
							<h2>Wecome to Glojivoc</h2>
							<p>
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.
							</p>
							<a href="#!" class="btn btn-text mt-15">About Company</a>
						</div>
					</div>
			...
			<div class="container text-center">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="single-fact mb-sm-30 mb-xs-50">
							...
							<div class="team-pic">
								<figure class="effect-zoe">
									...
									<figcaption>
										...
										<p class="icon-links">
											<a href="#"><span class="ion-social-facebook"></span></a><a href="#"><span class="ion-social-twitter"></span></a><a href="#"><span class="ion-social-whatsapp"></span></a>
										</p>
										<p class="description">
						...
						<div class="col-md-7">
							<div class="quote-box">
								...
								<div class="quote-text">
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply Lorem Ipsum has been the industry's standard.
									</p>
								</div>
		...
		<section class=" padding ptb-xs-40 project_bg">
			<div class="container">
				<div class="row pb-50 pb-xs-30 pb-sm-30">
					<div class="col-lg-4">
					...
					<div class="col-lg-8 d-flex justify-content-end">
						<ul class="container-filter categories-filter">
							...
							<li>
								<a class="categories" data-filter=".branding">Lawn Moving</a>
							</li>
							<li>
								<a class="categories" data-filter=".design">Landscape</a>
							</li>
							<li>
								<a class="categories" data-filter=".photo">Insect Control</a>
							</li>
				...
				<div class="row container-grid nf-col-3">
					...
					<div class="nf-item branding coffee spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								...
								<a href="assets/images/project/project_1.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
					...
					<div class="nf-item photo spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.html" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
								<a href="assets/images/project/project_2.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								<div class="gallery-heading">
									<h4><a href="#">Business Services</a></h4>
								</div>
							</div>
					...
					<div class="nf-item branding coffee spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.html" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
								<a href="assets/images/project/project_3.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								<div class="gallery-heading">
									<h4><a href="#">Business Services</a></h4>
								</div>
							</div>
					...
					<div class="nf-item design spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.html" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
								<a href="assets/images/project/project_4.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								<div class="gallery-heading">
									<h4><a href="#">Business Services</a></h4>
								</div>
							</div>
					...
					<div class="nf-item branding spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.html" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
								<a href="assets/images/project/project_5.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								<div class="gallery-heading">
									<h4><a href="#">Business Services</a></h4>
								</div>
							</div>
					...
					<div class="nf-item photo spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.html" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
								<a href="assets/images/project/project_6.jpg" class="fancylight same_style" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								<div class="gallery-heading">
									<h4><a href="#">Business Services</a></h4>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 mb-sm-30 mb-xs-30">
						<div class="img-scale">
							<figure>
								<img src="assets/images/blog/home_blog1.jpg" alt="">
							</figure>
					...
					<div class="col-md-4 mb-sm-30 mb-xs-30">
						<div class="img-scale">
							<figure>
								<img src="assets/images/blog/home_blog2.jpg" alt="">
							</figure>
							<div class="latest__block-post">
								<div class="meta-post">
									Jan, 24th 2018
					...
					<div class="col-md-4">
						<div class="img-scale">
							<figure>
								<img src="assets/images/blog/home_blog3.jpg" alt="">
							</figure>
							<div class="latest__block-post">
								<div class="meta-post">
									Jan, 24th 2018
		...
		<footer class="footer pt-80 pt-xs-60">
			...
			<div class="copyright">
				<div class="container">
					<p class="">
						© 2018 <a><b>Business Theme HTML5 Template</b></a>. All Rights Reserved.
					</p>
				</div>
			</div>
			<!-- End Copyright Bar -->
