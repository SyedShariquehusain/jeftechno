...
<html lang="en">
	<head>
					...
					<ul>
						...
						<li data-index="rs-129"  >
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									...
									<h2>We Provide Solution On Your Business</h2>
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever.
									</p>
									<a class="btn-text" href="#"> Read More <i class="fa fa-angle-double-right icon_effect"></i></a>
								</div>
							</div>
						</li>
						<!-- SLIDE  -->
						<li data-index="rs-130" data-title="" data-description="">
							...
							data-responsive_offset="on">
								<div class="banner-text">
									<span class="sub-text">we are here to help you</span>
									<h2>Get Help From Our Exparts</h2>
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever.
									</p>
									<a class="btn-text" href="#"> Read More <i class="fa fa-angle-double-right icon_effect"></i></a>
				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-4 col-lg-3 mt-xs-30">
						<div class="request_qoutebtn">
							<a href="#" class="btn-text withe_btn">Request a Quote <i class="fa fa-angle-double-right icon_effect"></i></a>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="section-title_home about_title pb-30 ">
										...
										<h2>we make functional & beautiful websites for business</h2>
									...
									<div class="about_btn">
										<a href="#" class="btn-text">About Us <i class="fa fa-angle-double-right icon_effect"></i></a>
									</div>
								</div>
				...
				<div class="row text-center light-color">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="section-title_home">
							<h2 class="mb-30">Company Overviewy</h2>
							<p>
		...
		<section class="padding ptb-xs-40 gray-bg service_sec">
			<div class="container">
				<div class="row text-center mb-20 mb-xs-30">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="section-title_home">
							<h2 class="mb-30">Quality Services</h2>
							<p>
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the 's standard dummy text.
							</p>
						</div>
				...
				<div class="row">
					...
					<!--Services Block-->
					<div class="services-block col-lg-4 col-md-6 col-xs-12 mb-30">
				...
				<div class="row text-center light-color">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="value_text">
							<h2>Perfection is Always Under Construction</h2>
							<a href="#" class="btn-text mt-30">Know More About Us <i class="fa fa-angle-double-right icon_effect"></i></a>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- End Work Section -->
		<section class="padding ptb-xs-40 bg_gradient img_1 section_box">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h2>A Digital Agency Crafting Beautiful Experiences.</h2>
						<div class="ptb-20">
					...
					<div class="col-md-6 col-lg-3 mb-xs-30">
						<div class="box_team">
							<div class="team_img">
								...
								<div class="team_social d-flex align-items-center">
									<ul>
										<li>
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-3 mt-sm-30 mt-xs-30 footer-latest-news">
						...
						<div class="single-news">
							...
							<span>13 June, 2018  /  Business</span>
						</div>
						<div class="single-news">
							<h5><a href="#">How can be successfull in market place..</a></h5>
							<span>13 June, 2018  /  Business</span>
			...
			<div class="bottom-footer text-center">
				<div class="container">
					<div class="bor_top clearfix">
						<p>
							Copyright © 2018 Business Theme. All rights reserved <a href="#">Glojivoc</a>
						</p>
