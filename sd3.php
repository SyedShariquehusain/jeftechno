			...
			<div class="container">
				<div class="row">
						...
						<div class="single-sidebar-widget">
							<div class="special-links">
								<ul>
									...
									<li>
										<a href="sd2.php">Earth Electrodes</a>
									</li>
									<li>
										<a class="active" href="sd3.php">Earthpit Chamber</a>
									</li>
									<li>
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						<div class="full-pic">
							<figure>
								<img src="assets/images/Earth Pit Chamber Banner.png" alt="">
							</figure>
						</div>
						<div class="text-box mt-40">
							<div class="box-title mb-20">
								<h3>EARTH PIT CHAMBER </h3>
								<!-- <h4>Reduce equipment failure and improve safety & reliability</h4> -->
							</div>
							<div class="text-content">
								<p>
								Earth pit Chamber protects the Earth Rod connection andmakes it available for inspection.They are used in order to secure protection for all earthing terminations and ensure easy access for routine testing of electrical earths. They provide secure and user-friendly accesses.
								</p>
								<h3>JEF EARTH PIT CHAMBER</h3>
								<p>JEF-HDPE Chambers & covers are eco-friendly, rust proof, heavy-duty, weather-proof earth pit made of high-grade material-polyethylene and have excellent durability and strength. They are easy to install and environment friendly.
								</p>
								
							</div>
							<div class="row mt-45 mt-xs-15 clearfix">
								<div class="col-md-5">
									<img class="img-responsive" src="assets/images/HDPE chamber.PNG" alt="Photo">
								</div>
